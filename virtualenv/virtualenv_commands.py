# Virtual Environment Command List
...
Output
    ...
    New python executable in C:\\Users\\david\\Desktop\\Environments\\project_env\\Scripts\\python.exe
...
----------------------------------------------------------
Output the content of requirements.txt
